            ...
            <main className="flex flex-col gap-6 px-6 pt-6 max-w-full mx-auto w-full box-border">
                ...
                <div className="flex flex-col gap-1 items-center text-center">
                    ...
                    <p className="text-xs text-(--color-text-muted) max-w-sm">
                        Crafting luxury beauty and wellness essentials for the modern routine.
                    </p>
                </div>
                ...
                {/* =================================================
                    ABOUT CONTENT
                    ================================================= */}
                <div className="w-full border border-(--color-border-strong) p-6 shadow-xs space-y-6 box-border text-center">
                    ...
                    <div className="space-y-3">
                        ...
                        <h2 className="text-base font-serif text-(--color-text)">
                            Pure Quality, Elevated Confidence
                        </h2>

                        <p className="text-xs text-(--color-text-muted) leading-relaxed">
                            At GlowaVee, we believe that self-care is an art
                            form. Founded on the principles of purity, elegance,
                            and uncompromised efficacy, our curation brings
                            together premium formulations designed to honor
                            your natural radiance.
                        </p>

                        <p className="text-xs text-(--color-text-muted) leading-relaxed">
                            Every item in our collection undergoes rigorous
                            vetting to ensure it meets our exacting standards
                            for sustainability, luxury, and performance.
                        </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-(--color-border)">
                        ...
                        {/* Premium Standards */}
                        <div className="p-4 border border-(--color-border) bg-(--color-background) space-y-3 flex flex-col items-center text-center">

                            <div className="flex flex-col items-center gap-2 text-(--color-gold-dark)">
                                <ShieldCheck size={18} />
                            ...
                            <p className="text-[11px] text-(--color-text-muted) leading-relaxed">
                                Sourced from trusted artisan laboratories
                        ...
                        <div className="p-4 border border-(--color-border) bg-(--color-background) space-y-3 flex flex-col items-center text-center">
                            ...
                            <p className="text-[11px] text-(--color-text-muted) leading-relaxed">
                                Dedicated support and tailored routines
                                curated for your unique skin profile.
                            </p>
